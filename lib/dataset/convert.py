...
id_dict = {'Car': 0, 'Bicycle': 1, 'Truck': 2, 'Bus': 3, 'Motorcycle': 4, 
'bike': 5}
id_dict_single =  {'Car': 0, 'Bicycle': 1, 'Truck': 2, 'Bus': 3, 'Motorcycle': 4, 
'bike': 5}
# id_dict = {'car': 0, 'bus': 1, 'truck': 2}
# id_dict = {'Car': 0, 'Bicycle': 1, 'Truck': 2, 'Bus': 3, 'Motorcycle': 4, 
# 'bike': 5}

# ['Car', 'Bicycle', 'TrafficSign', 'TrafficLight', 'Truck', 'Bus', 'Motorcycle', 'SpeedLimitSign', 'StaticBicycle',]
