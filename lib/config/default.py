...
_C.DATASET.DATAROOT = 'datasets/hefei-dataset/hefei_multi/images'       # the path of images folder
_C.DATASET.LABELROOT = 'datasets/hefei-dataset/hefei_multi/labels'      # the path of det_annotations folder
_C.DATASET.MASKROOT = 'datasets/hefei-dataset/hefei_multi/labels'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = 'datasets/hefei-dataset/hefei_multi/labels'               # the path of ll_seg_annotations folder
_C.DATASET.DATASET = 'HeFeiDataset'
...
# _C.DATASET = CN(new_allowed=True)
# _C.DATASET.DATAROOT = 'datasets/51sim_BDD_style/images'       # the path of images folder
# _C.DATASET.LABELROOT = 'datasets/51sim_BDD_style/labels'      # the path of det_annotations folder
# _C.DATASET.MASKROOT = 'datasets/51sim_BDD_style/depth_label'                # the path of da_seg_annotations folder
# _C.DATASET.LANEROOT = 'datasets/51sim_BDD_style/depth_label'               # the path of ll_seg_annotations folder
